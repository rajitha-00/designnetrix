    ...
    <section className="relative z-10 py-20 lg:py-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            We&apos;ve successfully launched 7+ projects across the UK,
            Australia, and Sri Lanka. From initial consultation to mega-project
            launches, we deliver high-impact digital results.
          </p>
        </motion.div>
