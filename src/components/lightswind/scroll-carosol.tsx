...
export const ScrollCarousel = forwardRef<HTMLDivElement, ScrollCarouselProps>(
  ({ features, className, maxScrollHeight }, ref) => {
    ...
    // Second row of cards (reversed for visual variety)
    const features2 = [...features].reverse();
    ...
    const renderFeatureCards = (
      ...
      featureSet.map((feature, index) => (
        <div
          ...
          className="feature-card flex-shrink-0 w-full mx-auto md:w-full h-full z-10 group relative transition-all duration-300 ease-in-out"
        >
          <div
            className={cn(
              `relative h-full p-6 lg:p-10 rounded-3xl backdrop-blur-sm 
          ...
          >
            ...
            <div className="absolute bottom-6 z-10 w-full px-6">
              ...
              >
                ...
                <p className="text-white text-sm lg:text-base mb-6 opacity-90 leading-relaxed">
                  {feature.description}
                </p>
                {/* <img
                  src={feature.image}
      ...
      >
        ...
        >
          ...
          <div
            ...
            className="flex flex-col md:flex-row gap-10 lg:gap-12 items-center h-full px-6 md:px-0 hidden xl:flex"
          >
