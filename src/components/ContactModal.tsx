    ...
    >
      ...
      <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 sm:p-8 max-w-sm sm:max-w-md w-full shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <Button
          ...
          variant="ghost"
          onClick={onClose}
          className="absolute top-3 right-3 sm:top-4 sm:right-4 text-white/60 hover:text-white h-8 w-8 sm:h-10 sm:w-10"
        >
          <CloseIcon />
        </Button>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <Button
            ...
            className="group w-full flex items-center justify-between p-3 sm:p-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-xl h-auto"
          >
